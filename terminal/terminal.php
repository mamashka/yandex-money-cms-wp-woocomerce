  ...
  class WC_terminal_Payu extends WC_Payment_Gateway{
   ...
   //   add_action('init', array(&$this, 'check_payu_response'));
    ...
    public function generate_payu_form($order_id){
        ...
        $txnid = $order_id;
	    $result ='';
		$result .= '<form name=ShopForm method="POST" id="submit_terminal_payment_form" action="https://money.yandex.ru/eshop.xml">'; //if you want demomode use https://demomoney.yandex.ru/eshop.xml
